...
import ru.netology.Saveliy.OperationHistoryApiApplicationTest;
import ru.netology.Saveliy.controller.CustomerController;
import ru.netology.Saveliy.controller.DTO.CustomerDTO;
import ru.netology.Saveliy.controller.DTO.CustomerGetResponse;
...
class CustomerControllerTest extends OperationHistoryApiApplicationTest {
    ...
    void addAndRemoveCustomer() {
        ...
        customerController.addCustomer(3, "Saveliy");
        ...
        assertEquals("Saveliy", newCustomer.getName());
